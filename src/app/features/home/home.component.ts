  ...
  tools = [
    {
      ...
      description: 'Visual node-based code generator for creating ML pipelines. Build complex workflows with an intuitive drag-and-drop interface.',
      features: [
    ...
    },
    {
      ...
      description: 'Automated code quality analysis and metrics. Get instant feedback on code maintainability, complexity, and best practices.',
      features: [
